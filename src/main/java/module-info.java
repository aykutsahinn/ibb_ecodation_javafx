...
module com.aykutsahin.ibb_ecodation_javafx {
    ...
    opens com.aykutsahin.ibb_ecodation_javafx.dto to javafx.base, lombok;
    ...
    opens com.aykutsahin.ibb_ecodation_javafx.dao to java.sql;

    // Veritabanı bağlantısı sağlayan sınıfların da SQL modülüne açık olması gerekiyor.
    opens com.aykutsahin.ibb_ecodation_javafx.database to java.sql;
    ...
    exports com.aykutsahin.ibb_ecodation_javafx.dao;

    // // Veritabanı bağlantı paketini dış dünyaya açıyoruz. Diğer modüller DB bağlantısını kullanabilir.
    exports com.aykutsahin.ibb_ecodation_javafx.database;

    // Ana paketi dış dünyaya açıyoruz. Diğer modüller bu paketin içeriğini kullanabilir.
    exports com.aykutsahin.ibb_ecodation_javafx;
    opens com.aykutsahin.ibb_ecodation_javafx.utils to javafx.base, lombok;
}
